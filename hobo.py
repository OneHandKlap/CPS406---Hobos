...
class Hobo:
    ...
    def __init__(self):
        self.hp = 20
        self.position = 0
        # List of lists, first represents the trainState of tracks this second, second list for next second
        self.info = [[], []]
    ...
    def act(self, smartness):
        if smartness == 0:
            ...
            # THIS SMARTNESS LEVEL JUMPS TO THE FIRST EMPTY TRACK
            # IF THERE ARE NO GOOD OPTIONS, USE THE PAPER PLANE (WHICH PURPORTS TO KNOW WHAT THE STATE WILL BE NEXT SECOND)
            ...
            # USES RUNNING MEANS TO DETERMINE THE LIKELIHOOD THAT A TRACK STATE WILL CHANGE, AND BECOME SAFE NEXT SECOND
            # IF >90% JUMP, ELSE JUMP TO FIRST EMPTY THIS TURN
            # print(trackSafeness)
